...
本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。上午题常考项目建议书、可行性研究、项目论证/评估的先后关系；案例题常用“未充分可研”解释后续失控。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜立项材料与可研深度（真题型改编训练题）**
>
> 某信息化项目采用新技术，团队缺少经验，用户数据基础也不完整。详细可行性研究中最应重点论证的是：
>
> A. 技术可行性和运行环境可行性  
> B. 项目经理个人偏好  
> C. 项目收尾报告格式  
...
**考查点：** 可行性研究内容、技术风险、运行环境。

**题干关键词：** 新技术、团队无经验、数据基础不足。

**解题过程：** 新技术缺经验直接指向技术可行性；用户数据基础不完整说明系统运行环境和业务条件不充分。
...
- B 不是正式可研内容。
- C 属于收尾材料，不解决立项可行性。
- D 是组织激励问题，不能替代投资与技术论证。

**举一反三：** 可研不是“写一份能过会的材料”，而是提前暴露技术、经济、运行、法律和社会条件是否支撑项目。
