...
## 本轮真题覆盖增强：变更请求到 CCB 闭环

本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。2019 范围案例和多类下午题都把“口头变更、客户直接找开发、领导直接指示”作为变更失控证据。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜变更请求到 CCB 闭环（真题型改编训练题）**
>
> 范围基准已确定后，客户提出新增功能。项目经理最合适的第一步是：
>
> A. 为维护客户关系，立即安排开发  
> B. 记录正式变更请求并组织影响分析  
> C. 让开发人员私下判断能不能做  
...
**考查点：** 整体变更控制流程、影响分析、CCB。

**题干关键词：** 新增功能、范围基准、第一步。

**解题过程：** 基准确定后的新增功能不是普通沟通事项，应先形成变更请求，再分析范围、进度、成本、质量、风险和合同影响。
...
**举一反三：** 变更题先问“有没有形成请求”，再问“有没有影响分析”，最后问“谁批准、是否更新基准并通知干系人”。
