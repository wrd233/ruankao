...
## 本轮真题覆盖增强：QA、QC 与质量审计边界

本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。2019 下午质量案例把 SQA、质量控制、质量计划编制混在一起，考角色独立性和过程/结果边界。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜QA、QC 与质量审计边界（真题型改编训练题）**
>
> 需求规格说明书未经内部评审就进入下一阶段，后来发现大量需求偏差。该问题最直接暴露的是：
>
> A. 质量计划和评审控制不足  
> B. 项目章程发布过早  
> C. 沟通渠道计算错误  
...
**考查点：** 质量保证、质量控制、评审、过程质量。

**题干关键词：** 未经评审、需求偏差、进入下一阶段。

**解题过程：** 需求评审是质量管理和阶段控制的重要活动，缺失会把错误带入设计和开发，造成后续返工。
...
**举一反三：** 质量题不要只盯最终测试，需求、设计、编码、集成都有质量活动；QA 偏过程，QC 偏结果检查。
