...
本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。2010 上半年上午题直接考“WBS 最底层工作单元不是功能模块”；下午范围题常从范围说明书和验收标准缺失切入。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜WBS 与工作包陷阱（真题型改编训练题）**
>
> 关于 WBS 的说法，错误的是：
>
> A. WBS 是管理项目范围的重要基础  
> B. WBS 最底层的工作单元通常称为工作包  
> C. WBS 最底层的工作单元称为功能模块  
> D. 大型复杂项目可采用列表形式表示 WBS

**考查点：** WBS、工作包、范围基准。

**题干关键词：** 最底层、功能模块、工作包。

**解题过程：** WBS 分解的是项目范围和可交付成果，最底层是便于估算、分派和控制的工作包，不等同于软件功能模块。
...
- A 是 WBS 的基本作用。
- B 是正确表述。
- D 对大型复杂项目常见，树形图虽直观但不一定便于大型项目维护。

**举一反三：** 软件项目可以按模块组织部分 WBS，但不能把“功能模块”当作 WBS 的标准最底层术语。
