...
本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。2019 下午范围案例中，视频聊天网站被客户理解为电子商务核心系统，核心失分点是需求确认、范围说明书、变更控制。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜范围蔓延与合同证据链（真题型改编训练题）**
>
> 客户提出新增核心功能，项目经理发现该功能未写入已签署的范围说明书。较稳妥的处理是：
>
> A. 立即无偿开发，避免客户不满  
> B. 依据范围基准确认偏差，提交变更请求并分析对工期、成本、质量和合同的影响  
> C. 让开发人员私下决定是否加班完成  
> D. 删除原范围说明书重新开始

**考查点：** 范围蔓延、变更控制、合同附件。

**题干关键词：** 新增核心功能、范围说明书、影响分析。

**解题过程：** 未纳入范围基准的新功能应通过变更流程处理，不能直接变成团队义务。
...
**举一反三：** 范围案例的证据链通常是：需求未澄清-范围说明书未确认-验收标准模糊-变更流程失效-进度/成本失控。
