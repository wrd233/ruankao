...
## 本轮真题覆盖增强：组织结构与 PM 权限

本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。组织结构题常考项目经理权限、资源可用性、成员双重汇报，以及 PMO 支持/控制/指令类型。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜组织结构与 PM 权限（真题型改编训练题）**
>
> 团队成员同时向职能经理和项目经理汇报，项目经理对资源有一定协调权但不是最高权威。这通常属于：
>
> A. 矩阵型组织  
> B. 纯职能型组织  
> C. 纯项目型组织  
...
**题干关键词：** 同时汇报、职能经理、项目经理、协调权。

**解题过程：** 双重汇报是矩阵型组织的典型特征；再根据 PM 权限强弱区分弱矩阵、平衡矩阵和强矩阵。
...
**举一反三：** 矩阵题不要看到“项目经理”就默认强权，要看资源控制权、预算权和成员汇报关系。
