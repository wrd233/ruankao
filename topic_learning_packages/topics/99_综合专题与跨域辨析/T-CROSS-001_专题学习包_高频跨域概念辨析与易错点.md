...
本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。真题喜欢把一个题干同时挂到范围、质量、变更、配置、风险等多个域，跨域辨析用于避免答偏。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜跨域易混概念反查（真题型改编训练题）**
>
> “测试通过的可交付成果”和“客户正式验收的可交付成果”之间最关键的区别是：
>
> A. 前者偏质量控制，后者偏确认范围  
> B. 前者偏合同收尾，后者偏风险识别  
> C. 两者完全等同  
...
**考查点：** 跨域辨析、质量控制 vs 确认范围。

**题干关键词：** 测试通过、客户验收、可交付成果。

**解题过程：** 质量控制先检查成果是否符合质量要求，确认范围再由客户/发起人正式接受成果。

**正确答案：** A。

**错项分析：**

- B 合同收尾可能在验收后发生，但不是这组概念的核心区别。
- C 忽略了内部核实和外部接受的边界。
- D 质量记录同样重要。

**举一反三：** 跨域题先问“谁在做、对象是什么、输出给谁、是否改变基准”，通常能把相似概念分开。
