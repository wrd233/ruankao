...
## 本轮真题覆盖增强：风险、问题、变更、应急措施边界

本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。案例题常把“新人生产率低”“可能继续延期”“已经发生缺陷”“提出新需求”混写在同一段。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜风险、问题、变更、应急措施边界（真题型改编训练题）**
>
> 项目已经出现关键人员离职，导致当前活动停滞；同时团队担心后续测试质量下降。较准确的判断是：
>
> A. 离职导致活动停滞是已发生问题，后续质量下降是风险  
> B. 两者都一定是机会  
> C. 两者都不需要记录  
> D. 只要写成变更请求即可

**考查点：** 风险 vs 问题、应急措施、问题日志。

**题干关键词：** 已经出现、担心后续、质量下降。

**解题过程：** 已发生并影响项目的是问题，应进入问题日志并处理；未来可能发生的不确定影响是风险，应进入风险登记册。
...
- B 明显不符合威胁情境。
- C 破坏跟踪闭环。
- D 变更请求只适用于需要改变基准或计划的事项，不能替代全部管理记录。

**举一反三：** 答案例时把时间状态先分清：已发生=问题/偏差，未发生但可能=风险，改变基准=变更。
