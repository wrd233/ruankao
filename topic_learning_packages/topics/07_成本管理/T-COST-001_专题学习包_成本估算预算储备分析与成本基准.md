...
本节把 `questions.full.clean.md` 与既有真题映射中的高频考法反查回本专题。2010 上午题考自下而上估算第一步、间接成本、EV 信息不足；成本专题要帮助判断“题目给的数据能不能算”。 学习时不要只背定义，要能从题干信号判断它在考哪一个管理动作或技术边界。
...
> **例题｜估算、预算与储备口径（真题型改编训练题）**
>
> 采用自下而上估算方法进行成本估算时，项目经理通常首先应该：
>
> A. 直接使用项目总预算倒推各阶段成本  
> B. 识别并估算每个工作包或最详细活动的成本  
> C. 只咨询财务部门确定总费用  
> D. 等项目执行后再记录实际成本

**考查点：** 自下而上估算、工作包成本、成本基准。

**题干关键词：** 自下而上、首先、工作包。

**解题过程：** 自下而上估算的关键是先估算底层工作包或活动，再逐级汇总得到项目成本估算。
...
- A 是自上而下分摊，不是自下而上。
- C 专家判断可辅助，但不能替代工作包估算。
- D 是实际成本记录，不是估算。

**举一反三：** 看到“工作包、最详细活动、逐级汇总”，定位自下而上；看到“历史类似项目”，定位类比估算。
